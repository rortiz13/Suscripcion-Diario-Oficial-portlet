...
import la.netco.generated.model.model.TipoDocumentoModel;
...
/**
 * The base model implementation for the TipoDocumento service. Represents a row in the &quot;suscripcion_TipoDocumento&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link la.netco.generated.model.model.TipoDocumentoModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link TipoDocumentoImpl}.
 * </p>
 *
 * @author smontanez
 * @see TipoDocumentoImpl
 * @see la.netco.generated.model.model.TipoDocumento
 * @see la.netco.generated.model.model.TipoDocumentoModel
 * @generated
 */
public class TipoDocumentoModelImpl extends BaseModelImpl<TipoDocumento>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a tipo documento model instance should use the {@link la.netco.generated.model.model.TipoDocumento} interface instead.
	 */
	public static final String TABLE_NAME = "suscripcion_TipoDocumento";
	public static final Object[][] TABLE_COLUMNS = {
			{ "id_tipo", Types.INTEGER },
			{ "nombre", Types.VARCHAR }
		};
	public static final String TABLE_SQL_CREATE = "create table suscripcion_TipoDocumento (id_tipo INTEGER not null primary key IDENTITY,nombre VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table suscripcion_TipoDocumento";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.la.netco.generated.model.model.TipoDocumento"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.la.netco.generated.model.model.TipoDocumento"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = false;
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.la.netco.generated.model.model.TipoDocumento"));
